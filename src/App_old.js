...
// PermissionRestrictedRoute component removed - now using ProtectedRoute
                ...
                {restaurantPermission?.permission === 0 ? (
                  ...
                  <>
                    ...
                    <Route path="restaurants" element={
                      <ProtectedRoute requiredPermission="Restaurants">
                        <Restaurants />
                      </ProtectedRoute>
                    } />
                    <Route
                      ...
                      element={
                        <ProtectedRoute requiredPermission="Purchase Analytics">
                          <PurchaseAnalytics />
                        </ProtectedRoute>
                      }
                    />
                    <Route
                      ...
                      element={
                        <ProtectedRoute requiredPermission="Delivery Timing">
                          <DeliveryTiming />
                        </ProtectedRoute>
                      }
                    />
