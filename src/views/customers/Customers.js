    ...
    <div className="p-4 min-h-screen" style={{ backgroundColor: 'var(--cui-body-bg)', color: 'var(--cui-body-color)' }}>
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          ...
          <CButton color="primary" onClick={handleBulkEmailHandlerClick} className="shadow-sm">
      ...
      <div>
        ...
        <CModal
          ...
          size="lg"
        >
          <CModalHeader className="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
            ...
            {selectedCustomerDetails && (
              <>
                ...
                {(selectedCustomerDetails.membership || selectedCustomerDetails.membershipName) && (
                  <CCard className="mb-4 border-0 shadow-sm bg-gradient-to-r from-blue-50 to-purple-50">
                    <CCardBody>
                      <h5 className="fw-bold mb-3 text-dark d-flex align-items-center gap-2">
