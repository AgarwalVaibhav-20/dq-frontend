...
const WooOrders = () => {
  ...
  const filteredAndSortedOrders = orders
    ?.filter((order) => {
      // Filter: Only show orders where from field is "delivery"
      const matchesDelivery = order.from === 'delivery'
      ...
      return matchesDelivery && matchesSearch && matchesStatus && matchesDate
    })
    ?.sort((a, b) => {
      let aValue, bValue
  ...
  return (
    <div style={{ paddingLeft: '20px', paddingRight: '20px' }}>
      ...
      <div className="text-center mb-4">
        <h2 className="mb-0">Delivery Orders</h2>
      </div>
